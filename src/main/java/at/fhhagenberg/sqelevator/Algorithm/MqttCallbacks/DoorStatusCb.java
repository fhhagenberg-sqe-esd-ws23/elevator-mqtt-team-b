...
public class DoorStatusCb implements MqttActionListener {
    ...
    public void onSuccess(IMqttToken asyncActionToken) {
        try {
            ...
            // set new door status
            int doorStatus = ByteBuffer.wrap(msg.getPayload()).getInt();
            buildingInfo.elevators[elevatorId].doorStatus = doorStatus;
        } 
